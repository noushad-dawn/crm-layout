...
//       ? new Date(order.dateOfOrder).toISOString().slice(0, 10) === filterDate
//       : true;
//     return isOrderIdMatch && isDateMatch;
//   });
...
//                     onClick={() => openNoteModal(order._id)} // Pass the entire order object
//                   >
//                     View Notes
//                   </button>
//                 </td>
